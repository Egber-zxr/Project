...
INSERT INTO `info` (`id`, `clientName`, `fileName`, `orgUrl`, `clientUrl`, `online`, `clientIp`) VALUES
	(1, 'W1', 'cifar-10-python.tar.gz', NULL, './datas/cifar-10-python.tar.gz', '1', 'http://127.0.0.1:8102/online'),
	(2, 'W2', 'cifar-10-python.tar.gz', NULL, './datas/cifar-10-python.tar.gz', '1', 'http://127.0.0.1:8102/online');
